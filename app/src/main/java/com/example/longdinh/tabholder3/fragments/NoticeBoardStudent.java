...
public class NoticeBoardStudent extends Fragment implements OnTabChangeListener,
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        v = inflater.inflate(R.layout.tabs_viewpager_layout_student, container, false);
        Spinner spinner = (Spinner) v.findViewById(R.id.spChild);
        app = (MyApplication) getActivity().getApplication();
        app.setCurrentchild(app.getId());
